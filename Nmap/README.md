...
These services are commonly used by Windows systems for network communication and file-sharing functionality.

## Result

Successfully scanned the local machine using Nmap and identified active ports and services.

## Conclusion

Nmap is a powerful network scanning tool used to discover hosts, identify open ports, and detect running services. This task provided practical experience in network reconnaissance and security assessment.
